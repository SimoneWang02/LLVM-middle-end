...
@.str = private unnamed_addr constant [32 x i8] c"%d, %d, %d, %d, %d, %d, %d, %d\0A\00", align 1

define dso_local void @foo(i32 noundef %0, i32 noundef %1) {
  %3 = add nsw i32 %0, 3, !loop-invariant !6, !code-motion !6
  %4 = add nsw i32 %0, 7, !loop-invariant !6, !code-motion !6
  %5 = add nsw i32 %0, 4, !loop-invariant !6, !code-motion !6
  %6 = add nsw i32 %0, 3, !loop-invariant !6, !code-motion !6
  %7 = add nsw i32 %3, 7, !loop-invariant !6, !code-motion !6
  %8 = add nsw i32 %4, 5, !loop-invariant !6, !code-motion !6
  br label %9
